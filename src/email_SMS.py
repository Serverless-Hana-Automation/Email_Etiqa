...
def send_sms(file_content, tomorrow_date_str):
    ...
    I hope this email finds you well. This email is a reminder about tomorrow's ("""+tomorrow_date_str+""") HANA SMS blast that we'll be conducting before the calls start.

    I have attached the list of phone numbers that we'll be using for SMS blast.
    ...
    file_part.add_header('Content-Disposition', 'attachment', filename=f'SMS_Blast_{tomorrow_date_str}.zip')
